...
function header(root = '', active = '') {
  ...
  <div class="header-right">
    ...
    <a href="${root}slop/archive" class="nav-link${active === 'archive' ? ' active' : ''}">Archive ↗︎</a>
    <a href="https://shop.foidslop.com/" target="_blank" rel="noopener noreferrer" class="nav-link header-shop">Shop ↗︎</a>
  </div>
</header>`;
}
...
<link rel="stylesheet" href="../css/slop-page.css?v=20260713-3"><link rel="stylesheet" href="../css/theme.css?v=20260713-4"></head><body>
...
<nav class="slop-nav" aria-label="Other slops">${previous ? `<a href="./${previous.slug}" class="slop-nav-item prev"><span class="slop-nav-dir">←︎ Previous Slop</span><span class="slop-nav-name">${esc(previous.name)}</span><span class="slop-nav-date">${prettyDate(releaseDate(previous))}</span></a>` : '<span></span>'}${next ? `<a href="./${next.slug}" class="slop-nav-item next"><span class="slop-nav-dir">Next Slop →︎</span><span class="slop-nav-name">${esc(next.name)}</span><span class="slop-nav-date">${prettyDate(releaseDate(next))}</span></a>` : `<a href="./today" class="slop-nav-item next"><span class="slop-nav-dir">Next Slop →︎</span><span class="slop-nav-name">Check back tomorrow</span></a>`}</nav></main>
...
function renderHomepage() {
  ...
  return renderHomepageBase()
    ...
    .replace('</section></div></main>', '<a class="zine-rss" href="feed.xml" type="application/atom+xml">Follow the daily slop via RSS ↗︎</a></section></div></main>');
}
...
function updateArchive() {
  ...
  html = html.replace(/<link rel="canonical" href="[^"]+">/, `<link rel="canonical" href="${BASE_URL}/slop/archive">`)
    ...
    .replace('<link rel="stylesheet" href="../css/slop-archive.css">', '<link rel="stylesheet" href="../css/slop-archive.css">\n<link rel="stylesheet" href="../css/theme.css?v=20260713-4">')
